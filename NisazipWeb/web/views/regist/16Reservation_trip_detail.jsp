...
<%
	// ArrayList<T_RESERVATION> list = (ArrayList<T_RESERVATION>) request.getAttribute("trip_reservation");
...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<div class="w3-container" style="margin-top: 80px" id="showcase">
			...
			<h3 class="w3-center"><b>예약한 Trip 정보 </b> &nbsp; <a id="btn_style" onclick="goMain();">메인으로</a></h3>
			</h1>
		</div>
	...
	<div>
		<h1 class="w3-center"
			...
			<b><i> 등록 Trip 예약자 정보</i></b>
		</h1>
	</div>
	<h4 style="margin-top: 100px; margin-left: 500px;">
		예약 번호:<%=trip_reservation.getT_reser_no()%>
	</h4>
	<br>
	<br>
	<%-- <h4 style="margin-left:500px;">유저 아이디: <%=res.getUser_id() %></h4><br /><br /> --%>
	<table class="table" border="3px; solid;"
		style="font-size: 15px; margin-left: 400px; text-align: center; width: 50%">
		<thead>
			<tr>
				<th>No.</th>
				<th>고객아이디</th>
		...
		<tbody>
			<tr>
				...
				<td><%=trip_reservation.getT_date()%></td>
				<td><%=trip_reservation.getGuest_num()%></td>
				<td><%=trip_reservation.getTotal_price()%></td>
			</tr>
		</tbody>
	</table>
</body>
