...
<body>
	...
	<div class="w3-main" style="margin-left: 340px; margin-right: 40px">
		...
		<div style="font-weight: bold; font-size: 29px;" class="w3-center">
			<textarea id="introduce" name="introduce" style="width: 700px; height: 300px;"></textarea>
			<br> 
			<a href="<%=request.getContextPath() %>/views/regist/6trip_timeStartEnd.jsp" id="btn_style" class="w3-padding-large w3-button w3-center">이전단계</a> 
