    ...
    <form action="<%=request.getContextPath()%>/insertReservation.trip" method="post">
        <div class="w3-main" style="margin-left:340px;margin-right:40px">
            ...
            <div style="font-weight: bold; font-size: 29px;" class="w3-center">
                ...
                <a href="<%=request.getContextPath() %>/views/regist/7trip_introduce.jsp" id="btn_style" class="w3-padding-large w3-button w3-center">이전단계</a>
    ...
    $(function(){
		$("#btn_style1").click(function(event){
			...
			var datepicker2 = $('#datepicker2').val();
			 ...
			 // alert("datepicker1 : " + datepicker1);
			if(datepicker1 == ""){
	        	alert("My Trip에 대한 예약 시작일을 설정하세요.");
	        	if(datepicker2 == ""){
		        	alert("My Trip에 대한 예약 종료일을 설정하세요.");
				}
			} else if(datepicker2 == ""){
	        	alert("My Trip에 대한 예약 종료일을 설정하세요.");
	        	if(datepicker1 == ""){
