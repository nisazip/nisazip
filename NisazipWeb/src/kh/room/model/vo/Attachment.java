...
public class Attachment implements Serializable {
	...
	public Attachment(String pno, String r_id, String hosting_id, String origin_name, String change_name,
			String file_path, String upload_date, int file_level) {
		super();
		this.pno = pno;
		this.r_id = r_id;
	...
	public String toString() {
		return "Attachment [pno=" + pno + ", r_id=" + r_id + ", hosting_id=" + hosting_id + ", origin_name="
				+ origin_name + ", change_name=" + change_name + ", file_path=" + file_path + ", upload_date="
				+ upload_date + ", file_level=" + file_level + "]";
	}
