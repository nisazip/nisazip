 ...
 */
@WebServlet("/rInsert2.do")
public class RInsertServlet2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RInsertServlet2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String R_OPTION = String.join("| ", request.getParameterValues("R_OPTION"));
		...
		request.getRequestDispatcher("views/room/RoomInsert3.jsp").forward(request, response);		
