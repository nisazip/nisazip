...
public class Host_Picture {
	...
	public Host_Picture(int pno, String hosting_id, String origin_name, String change_name, String file_path,
	...
	public String toString() {
		return "Host_Picture [pno=" + pno + ", hosting_id=" + hosting_id + ", origin_name=" + origin_name
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Host_Picture other = (Host_Picture) obj;
		if (change_name == null) {
