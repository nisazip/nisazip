...
public class ModifyTripServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("수정 페이지 서블릿 userId : " + userId);

		Trip tr = new Trip();
		Trip origin_tr = new TripRegistService().getTrip(userId);
		ArrayList<Attachment> origin_list = new TripRegistService().getPicture(userId);
	...
	public void fileCheck(int idx, String fileName, ArrayList<Attachment> origin_list, ArrayList<Attachment> fileList,
